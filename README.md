...
...
```
(Дополнительные 5 баллов можно получить, решив эту задачу, используя многопоточное программирование - много поточность и синхронизацию потоков)
...
Должны быть реализованы режимы ручного и автоматического (по таймеру) перелистывания изображений.
